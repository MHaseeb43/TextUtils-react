...
export default function About() {
  ...
  const [textbtn, mytextbtn] = useState("Enable Dark Mode")
        ...
        <h1>About Us</h1>
                ...
                <div className="accordion-item" style={style}>
                    ...
                    <div className='container my-3'>
                        <button type='button' onClick={toggledark} className='btn btn-outline-primary' style={style}> {textbtn} </button>
                    </div>
          </div>
  )
}
